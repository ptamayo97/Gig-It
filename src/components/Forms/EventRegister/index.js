...
import { MDBRow, MDBCol, MDBBtn, MDBCard, MDBCardBody, MDBSelectOption,MDBSelect,MDBContainer,MDBNavLink ,MDBTabContent,MDBNav,MDBNavItem,MDBTabPane,MDBSelectInput,MDBSelectOptions} from 'mdbreact';
...
class SignIn extends Component {
  ...
  selectNextTab = () => {
	...
	render() {
		...
		return (
            <MDBContainer header="Checkout panel" className="px-4" noBorder>
                    ...
                    <MDBCol lg="8" className="mb-4">
                      <MDBNav pills color="primary" className="nav-justified">
                        ...
                        <MDBNavItem>
                          ...
                          >
                            <strong>2. Register Location</strong>
                          </MDBNavLink>
                        </MDBNavItem>
                        <MDBNavItem>
                          <MDBNavLink
