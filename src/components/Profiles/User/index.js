...
import { MDBRow, MDBCol, MDBCard, MDBCardBody, MDBInput, MDBContainer, MDBAvatar, MDBIcon, MDBBtn } from 'mdbreact';
import './style.css';
						...
						<MDBCol md='8' className='mb-r'>
							<MDBCard cascade className='cascading-admin-card user-card'>
								<div className='admin-up d-flex justify-content-start'>
									<MDBIcon icon='users' size='4x' className='info-color py-4 z-depth-2' />{' '}
									<div className='data'>
										<h5 className='font-weight-bold dark-grey-text'>
											Edit Profile - <span className='text-muted'>Complete your profile</span>
										</h5>
									</div>
								</div>
								<MDBCardBody>
